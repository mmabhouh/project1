...
<header>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item active" style="background-image: url('{{asset('news/img/1.jpg')}}')">
            ...
            <div class="carousel-item" style="background-image: url('{{asset('news/img/1.jpg')}}')">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="col-lg-4 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-footer">
                        <a href="{{route('news.detailes')}}" class="btn btn-primary">Learn More</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
...
<section class="gray-sec">
    <div class="container">
        ...
        <div align="center"><a class="btn btn-success" href="{{route('news.all')}}">more news</a></div>
    </div>
</section>
<section >
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3  portfolio-item">
                <div class="card h-100">
                    ...
                    <div class="card-footer">
                        <ahref="{{route('news.detailes')}}" class="btn btn-primary">Learn More</ahref=>
                    </div>
                </div>
            </div>
            <div class="col-lg-3  portfolio-item">
                <div class="card h-100">
                  <a href="#"><img class="card-img-top" src="{{asset('news/img/s3.jpg')}}" alt=""></a>                  <div class="card-body">
                        <h4 class="card-title">
